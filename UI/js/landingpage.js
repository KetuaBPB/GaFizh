...
const setIndexSiteLanguage = (path, language) => {
    fetch(path)
        ...
        .then(data => {
            ...
            document.querySelectorAll('.get-started-text').forEach(_ => _.textContent = data['get-started-text']);
...
if (translateLanguage != undefined) {
    ...
    setIndexSiteLanguage(`assets/JSON/landing-indonesia.json`, 'indonesia')
}